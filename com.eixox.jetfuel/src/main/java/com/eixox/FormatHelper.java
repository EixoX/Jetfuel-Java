...
public class FormatHelper {
	...
	public static final String cep(int value) {
		return StringHelper.concat(zeroPadLeft(value / 1000, 5), "-", zeroPadLeft(value % 1000, 3));
	}
	...
	public static final String cpf(long value) {
		return StringHelper.concat(zeroPadLeft(((value / 100000000) % 1000), 3), ".", zeroPadLeft(((value / 100000) % 1000), 3), ".",
				zeroPadLeft(((value / 100) % 1000), 3), "-", zeroPadLeft((value % 100), 2));
	}

	public static final String cnpj(long value) {
		return StringHelper.concat(zeroPadLeft(((value / 1000000000000L) % 100), 2), ".", zeroPadLeft(((value / 1000000000) % 1000), 3), ".",
