...
public class CVM_CTR {
	...
	public void read(String line) {
		this.codigoCvm = IntegerAdapter.ENGLISH.parseInteger(line.substring(0, 6));
		this.dataExercicio = DateYmdAdapter.parseTimestamp(line.substring(6, 14));
		this.tipoDocumento = IntegerAdapter.ENGLISH.parseInteger(line.substring(14, 15));
		this.cnpj = LongAdapter.ENGLISH.parseLong(line.substring(15, 29));
