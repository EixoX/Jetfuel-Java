...
public final class HtmlBuilder {
	...
	public final HtmlBuilder appendRaw(Object item) {
		this.builder.append(item);
		return this;
	}

	public final HtmlBuilder appendRaw(String item) {
		this.builder.append(item);
		return this;
	}

	public final HtmlBuilder appendContent(String item) {
		if (this.tagOpen) {
			builder.append('>');
			this.tagOpen = false;
		}
	...
	public final HtmlBuilder closeTag(String tagName) {
		if (this.tagOpen) {
			builder.append(" />\r\n");
		} else {
			builder.append("</");
	...
	public final HtmlBuilder appendAttribute(String name, Object value) {
	...
	static {
		...
		charToEntity = Collections.unmodifiableMap(map);
	}
}
